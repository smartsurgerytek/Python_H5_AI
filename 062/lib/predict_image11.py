...
import time
import sys
import datetime            #1130511
from datetime import date  #1130511
...
class PredFolderImg(object):
    ...
    def get_pred_label(self, img): #1110911
        resize_img = cv2.resize(img, (512, 512), interpolation=cv2.INTER_CUBIC) #1120801
        # resize_img = self.preprocessInput(resize_img) # 1120801
                    ...
                    try:
                        ...
                        if os.listdir(self.load_folder_path) != []:
                            ...
                            for file_name in os.listdir(self.load_folder_path):
                                ...
                                time.sleep(0.01) #避免存檔不完全11120725
